...
import 'package:baby_diary/vaccination/bloc/vaccination_bloc.dart';
...
import 'package:baby_diary/vaccination/child_widget/vaccination_row.dart';
...
class _VaccinationState extends BaseStatefulState<Vaccination> {
  ...
  Future<void> _refresh() async {
    vaccinationBloc.add(const RefreshVaccination());
  }
