import 'package:baby_diary/baby_height/baby_height_row.dart';
import 'package:baby_diary/baby_height/bloc/baby_height_bloc.dart';
...
class _DiaryListState extends BaseStatefulState<HeightList> {
  ...
  Widget? buildBody() {
    return BlocProvider(
        ...
        child: BlocListener<BabyHeightBloc, BaseState> (
                              ...
                              children: [
                                SlidableAction(
                                  ...
                                  onPressed: (BuildContext context) {
                                    HeightModel height = heightBloc.heightList[index];
